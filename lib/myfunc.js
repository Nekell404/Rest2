...
exports.serialize = (aqua, m) => {
    ...
    try{
        ...
        m.quotedMsg.fromMe = m.quotedMsg.sender === aqua.user.id.split(':')[0]+'@s.whatsapp.net' ? true : false
    ...
    if (m.key.fromMe){
        m.sender = aqua.user.id.split(':')[0]+'@s.whatsapp.net'
    }
